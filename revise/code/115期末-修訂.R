...
# [修訂] 路徑改為相對於 repo 根目錄。run-all.R 會先定義 REPO_ROOT、FIG_DIR、TBL_DIR；
...
write.xlsx(
  ...
  file = file.path(TBL_DIR, "月平均搭乘里程.xlsx"),
...
plot_avg_daily_use = function(
  ...
  # [修訂 A1/A2] 業者資料不完整月份
  flag_points(x, y, data$月份, flag, cex = 1.3)
...
plot_avg_daily_use(
  花蓮市區_單日平均使用次數,
  "113年6月至115年6月花蓮縣市區客運單日平均使用次數折線圖",
  "花蓮市區客運單日平均使用次數.png",
  flag = FLAG_MONTHS$花蓮市區,
  ycol = "單日平均使用次數",
  ylab = "單日平均使用次數"
...
plot_avg_daily_use(
  臺東市區_平均每日使用次數,
  "113年6月至115年6月臺東縣市區客運平均每日使用次數折線圖",
  "臺東市區客運平均每日使用次數.png"
)
...
plot_frequency_count(
  花蓮市區_搭乘區間$table,
  "113年6月至115年6月花蓮縣市區客運乘客單日搭乘次數區間月人數變化折線圖",
...
plot_frequency_count(
  臺東市區_搭乘區間$table,
  "113年6月至115年6月臺東縣市區客運乘客各搭乘次數區間月人數變化折線圖",
...
plot_frequency_count(
  花蓮市區_TPASS搭乘區間$table,
  "113年6月至115年6月花蓮縣市區客運TPASS乘客單日搭乘次數區間月人數變化折線圖",
...
plot_frequency_count(
  臺東市區_TPASS搭乘區間$table,
  "113年6月至115年6月臺東縣市區客運TPASS乘客各搭乘次數區間月人數變化折線圖",
...
write.xlsx(
  ...
  file = file.path(TBL_DIR, "平均每日使用次數及其族群分布.xlsx"),
  overwrite =
    TRUE
)
...
write.xlsx(
  ...
  file = file.path(TBL_DIR, "平均轉乘次數.xlsx"),
